...
import Manager.Service.AddressDetail;
...
public class ManagerController {
    ...
    public ArrayList<String> getCity() {
        AddressDetail service = new AddressDetail();        
        return service.getCityList();
    }
    
    public ArrayList<String> getDistrictofCity(String cName) {
        AddressDetail service = new AddressDetail();        
        return service.getDistrictByCityName(cName);
    }
    
    public ArrayList<String> getWardofDistrict(String dName) {
        AddressDetail service = new AddressDetail();        
        return service.getWardtByDistrictName(dName);
    }
}
