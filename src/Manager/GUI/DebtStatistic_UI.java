 ...
 * @author HOME
 */
public class DebtStatistic_UI extends javax.swing.JFrame {
    ...
    public DebtStatistic_UI(String mnid) {
        initComponents();
    ...
    public static void main(String args[], String mnID) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DebtStatistic_UI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DebtStatistic_UI(mnID).setVisible(true);
            }
        });
    }
