...
public class ViewEPLimitPeopleDESC {
    ...
    public ArrayList<EssentialPackage> getEssentialPackageLimitPeopleDESC() {
        EssentialPackage temp = null;
        ArrayList<EssentialPackage> list = new ArrayList<EssentialPackage>();

        try {
            sql = "SELECT * FROM essentials_package ORDER BY LimitPerPeople DESC";
