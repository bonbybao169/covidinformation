...
public class ViewEPLimitTimeDESC {
    ...
    public ArrayList<EssentialPackage> getEssentialPackageLimitTimeDESC() {
        EssentialPackage temp = null;
        ArrayList<EssentialPackage> list = new ArrayList<EssentialPackage>();

        try {
            sql = "SELECT * FROM essentials_package ORDER BY ExpiredDate DESC";
